...
get_hand_type :: proc(hand: string) -> Hand_Type {
	...
	for val, i in sorted_values {
		...
		else if val == 4 do return Hand_Type.FOUR_OF_A_KIND
		else if val == 3 && array_contains_other_elements(sorted_values, 2, i) do return Hand_Type.FULL_HOUSE
		else if val == 3 do return Hand_Type.THREE_OF_A_KIND
		else if val == 2 && array_contains_other_elements(sorted_values, 2, i) do return Hand_Type.TWO_PAIRS
		else if val == 2 do return Hand_Type.ONE_PAIR
